...
class Application(ThemedTk):
    ...
    def show_login(self):
        ...
        tk.Entry(self, textvariable=self.username, bg="#555555", fg="white", insertbackground="white").pack()
        tk.Label(self, text="Password", bg="#333333", fg="white").pack(pady=10)
        tk.Entry(self, textvariable=self.password, show="*", bg="#555555", fg="white", insertbackground="white").pack()
    ...
    def show_signup(self):
        ...
        tk.Label(self, text="Username", bg="#333333", fg="white").pack(pady=10)
        self.new_username_entry = tk.Entry(self, textvariable=self.new_username, bg="#555555", fg="white", insertbackground="white")
        ...
        tk.Label(self, text="Password", bg="#333333", fg="white").pack(pady=10)
        tk.Entry(self, textvariable=self.new_password, show="*", bg="#555555", fg="white", insertbackground="white").pack()
        tk.Label(self, text="Confirm Password", bg="#333333", fg="white").pack(pady=10)
        tk.Entry(self, textvariable=self.confirm_password, show="*", bg="#555555", fg="white", insertbackground="white").pack()
    ...
    def show_games_tab(self):
        ...
        games = get_games()
        if not games:
            tk.Label(self.games_tab, text="No games available", bg="#333333", fg="white").pack()
            return
    ...
    def show_create_tab(self):
        ...
        ttk.Label(self.create_tab, text="Game Name", background="#333333", foreground="white").pack(pady=10)
        tk.Entry(self.create_tab, textvariable=self.create_game_name, bg="#555555", fg="white", insertbackground="white").pack()

        ttk.Label(self.create_tab, text="Game Directory", background="#333333", foreground="white").pack(pady=10)
        self.create_game_dir = ttk.Button(self.create_tab, text="Select Directory", command=self.select_game_dir)
        self.create_game_dir.pack()

        ttk.Label(self.create_tab, text="Main Game File", background="#333333", foreground="white").pack(pady=10)
        self.create_game_main_file_btn = ttk.Button(self.create_tab, text="Select Main File", command=self.select_main_file)
        self.create_game_main_file_btn.pack()

        ttk.Label(self.create_tab, text="Game Icon", background="#333333", foreground="white").pack(pady=10)
        self.create_game_icon_btn = ttk.Button(self.create_tab, text="Select Icon", command=self.select_icon_file)
        self.create_game_icon_btn.pack()

        ttk.Button(self.create_tab, text="Upload Game", command=self.upload_game).pack(pady=10)
    ...
    def show_chat_tab(self):
        for widget in self.chat_tab.winfo_children():
            widget.destroy()
        ttk.Label(self.chat_tab, text="Chat feature not implemented yet", background="#333333", foreground="white").pack(pady=10)

    def show_settings_tab(self):
        for widget in self.settings_tab.winfo_children():
            widget.destroy()
        ttk.Label(self.settings_tab, text="Settings feature not implemented yet", background="#333333", foreground="white").pack(pady=10)
